...
export async function createSession(database:Queryable, subject:AccessSubject, deviceId:string | null, config:CloudConfig) {
  ...
  await database.query(
    `INSERT INTO refresh_tokens (id, subject_type, subject_id, device_id, token_hash, expires_at)
     VALUES ($1,$2,$3,$4,$5,$6)`,
    [randomUUID(), subject.subjectType, subject.subjectId, deviceId, hashOpaqueToken(refreshToken, config.KEY_PEPPER), expiresAt],
  );
